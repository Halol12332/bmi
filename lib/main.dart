...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    _imageBMI = const AssetImage('images/empty.png');
  }
...
//Calculate BMI
      ...
      if (_bmi < 18.5) {
        _imageBMI = const AssetImage('images/under.png');
      } else if (_bmi > 25) {
        _imageBMI = const AssetImage('images/over.png');
      } else {
        _imageBMI = const AssetImage('images/normal.png');
      }
    });
  }
